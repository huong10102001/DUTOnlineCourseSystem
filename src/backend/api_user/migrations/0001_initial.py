# Generated by Django 3.2.8 on 2022-10-11 14:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'ADMIN'), ('LECTURER', 'LECTURER'), ('USER', 'USER')], default='USER', max_length=50)),
                ('is_lecturer', models.BooleanField(default=None, null=True)),
