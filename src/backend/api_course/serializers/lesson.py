...
class LessonSerializer(serializers.ModelSerializer):
    ...
    quizzes = QuizSerializer(required=False, many=True)

    class Meta:
        model = Lesson
        fields = ['id', 'title', 'content', 'previous_lesson', 'previous_lesson_id', 'chapter_id',
                  'chapter', 'attachment_id', 'attachment', 'slug', 'discussions', 'quizzes']
        extra_kwargs = {
...
class ListLessonSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Lesson
        fields = ['id', 'title', 'content', 'chapter_id', 'attachment_id', 'attachment',
                  'previous_lesson_id', 'previous_lesson', 'slug', 'quizzes', 'discussions']
        depth = 1
