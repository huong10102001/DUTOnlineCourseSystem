    ...
    return (
        <View style={tw`bg-white w-full p-8 flex h-full justify-center`}>
            ...
            <View style={{ flex: 1,flexDirection: "row",justifyContent:"space-between"}}>
                <TouchableHighlight style={{flex:1,borderRadius:10,marginRight:4}} onPress={()=>{setRole("user");}} activeOpacity={0.6} underlayColor="#DDDDDD">
                    <View style={{ flex: 5, textAlign: "center",justifyContent:"center" , borderWidth:1, borderColor:changeBorder("user"), borderRadius:10}}>
                        <FontAwesome size={30} color="black" name='graduation-cap' />
                        <Text>A student,</Text>
                        <Text>loking for a course</Text>
                    </View>
                </TouchableHighlight>
                <TouchableHighlight style={{flex:1,borderRadius:10,marginLeft:4}} onPress={()=>{setRole("lecture");}} activeOpacity={0.6} underlayColor="#DDDDDD">
                    <View style={{ flex: 5, textAlign: "center",justifyContent:"center" , borderWidth:1, borderColor:changeBorder("lecture"), borderRadius:10}}>
            ...
            <View style={styles.checkboxContainer}>
                ...
                <TouchableOpacity><Text style={styles.terms}>Terms </Text></TouchableOpacity>
                <Text>and </Text>
                <TouchableOpacity><Text style={styles.privacy}>Privacy</Text></TouchableOpacity>
            </View>
            <Text style={{color:'red',fontWeight:700}}>{`${error}` || `${error_api}`}</Text>
